...
# using ridge for an estimator
# 相関高い変数は絞る
# areaのrootをとる。これで目的変数との関係が線形になる
...
### area ###
train_use["area"] = np.sqrt(train_processed["area"])
test_use["area"] = np.sqrt(test_processed["area"])
...
### contract_period ###
period_cols = ["fixed_term", "contract_period_in_months"]
