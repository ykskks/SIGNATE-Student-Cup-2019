...
# added town_cleaned to categorical_features
...
over_50_town = train["town"].value_counts().index[train["town"].value_counts() >= 50]
train["town_cleaned"] = train["town"].apply(lambda x: x if x in over_50_town else "not_in_over_50")
test["town_cleaned"] = test["town"].apply(lambda x: x if x in over_50_town else "not_in_over_50")
...
categorical_cols = ["districts", "town_cleaned", "has_nando", "is_R", "is_K", "is_DK", "is_LDK",
